...
Instance::Instance(EndpointId aEndpointId, Delegate  &aDelegate, BitMask<Feature> aFeature, BitMask<OptionalAttributes> aOptionalAttrs,
                   BitMask<OptionalCommands> aOptionalCmds) :
...
void ESPMatterEnergyEvseClusterServerInitCallback(chip::EndpointId endpoint) {}
void ESPMatterEnergyEvseClusterServerShutdownCallback(chip::EndpointId endpoint, chip::app::ClusterShutdownType shutdownType) {}
